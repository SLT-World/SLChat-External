...
.embed.site { border: none; padding: 0 0 10px 0; display: flex; flex-direction: column; gap: 10px; align-items: stretch; }
.embed.site > img { order: -1; border: none; border-radius: 0; background: var(--primary-color); width: 100%; }
